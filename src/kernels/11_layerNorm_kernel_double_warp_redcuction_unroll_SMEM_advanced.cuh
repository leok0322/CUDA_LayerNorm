...
__global__ void LayerNorm_kernel_double_warp_reduction_unroll_SMEM_advanced(const scalar_i totalRow, const scalar_i totalCol, scalar_t *A,
  ...
  // 加载WeightAndBias
  scalar_i threadIdxForLoadWeightAndBias {threadIdx.y * blockDim.x + threadIdx.x};
  scalar_i threadNumForLoadWeightAndBias { blockDim.y * blockDim.x};
