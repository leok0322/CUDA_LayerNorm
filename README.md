...
| Size | K0 Base | K1 Naive | K2 DblWarp | K3 Unroll | K4 Welford | K5 Welf+Unroll | K6 SMEM | K7 CG Warp | K8 CG Block | K9 Advanced | K10 Warp+SMEM |
|------|--------:|---------:|-----------:|----------:|-----------:|---------------:|--------:|-----------:|------------:|------------:|--------------:|
| 128  |     3.2 |      2.6 |        9.7 |      15.3 |        8.7 |            7.4 |    16.7 |       16.5 |        14.7 |        18.5 |          21.8 |
| 256  |     7.2 |      2.9 |       33.3 |      43.0 |       23.4 |           17.3 |    53.1 |       81.0 |        36.0 |        66.7 |          78.3 |
| 512  |     4.8 |      2.5 |       69.0 |     128.0 |       44.1 |           35.7 |   151.1 |      238.0 |        81.4 |       220.7 |         214.2 |
| 1024 |     2.3 |      2.9 |      119.8 |     231.1 |       92.2 |           94.7 |   237.9 |      159.2 |       125.7 |       231.8 |         205.8 |
| 2048 |     1.3 |      3.0 |      186.0 |     257.3 |      151.6 |          160.8 |   259.1 |      137.0 |       172.7 |       257.5 |         169.3 |
| 4096 |     0.6 |      3.1 |      263.2 |     247.5 |      233.8 |          233.0 |   267.2 |      134.8 |       204.7 |       242.8 |         113.8 |

**K6 vs K0（4096×4096）**：267.2 / 0.6 = **445×**

<!-- performance_plot -->
![CUDA LayerNorm Kernel Performance](performance_plot.png)
<!-- performance_plot -->

> 虚线为 K0 base reference，与对应维度折线同色。黑色虚线为各 kernel 在所有维度上的平均值。
...
```bash
uv run plot_performance.py              # 绘制默认 6 个方阵维度
uv run plot_performance.py 512 1024 4096  # 指定维度
uv run plot_performance.py --all-sizes  # 绘制 logs 中所有维度
```
